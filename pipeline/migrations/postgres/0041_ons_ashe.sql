...
--
-- PostgreSQL dialect of ../0041_ons_ashe.sql. See README.md in this directory for
...
CREATE TABLE IF NOT EXISTS ons_ashe_observations (
    ...
    value                  double precision, -- the observation as a number; NULL where it is not one
