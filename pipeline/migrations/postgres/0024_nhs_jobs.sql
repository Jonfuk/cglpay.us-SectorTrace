...
--
-- PostgreSQL dialect of ../0024_nhs_jobs.sql. See README.md in this directory for
...
CREATE OR REPLACE VIEW v_nhs_repeat_advertised_roles AS
    SELECT provider_key,
           employer_name_raw,
           ...
           -- SQLite's GROUP_CONCAT. Neither engine specifies the order of
           -- the concatenated values and neither is asked to: these are
           -- references to look up, not a sequence that means anything.
           string_agg(job_reference, ', ')    AS job_references
