...
--
-- PostgreSQL dialect of ../0057_sar_reports.sql. See README.md in this
...
CREATE TABLE IF NOT EXISTS sar_documents (
    ...
    library_year          bigint NOT NULL, -- the year section the library filed it under; NOT a publication date
    ...
    -- choice and why.
    sab_name                text,
    has_body_text              bigint NOT NULL, -- whether text extraction succeeded
