...
--
-- PostgreSQL dialect of ../0023_entity_graph.sql. See README.md in this directory for
...
CREATE OR REPLACE VIEW restricted_v_shared_officers AS
...
CREATE OR REPLACE VIEW restricted_v_officer_edges AS
...
CREATE OR REPLACE VIEW v_entity_edge_confidence AS
    SELECT relationship,
           basis,
           COUNT(*) AS edges
      FROM v_entity_edges
