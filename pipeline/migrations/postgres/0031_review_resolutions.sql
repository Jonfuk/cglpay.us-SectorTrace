...
--
-- PostgreSQL dialect of ../0031_review_resolutions.sql. See README.md in this directory for
-- the conversion rules.
--
CREATE TABLE IF NOT EXISTS review_resolutions (
    id              bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    review_item_id  bigint NOT NULL REFERENCES review_queue (id) ON DELETE CASCADE,
