...
_DOMAINS: tuple[AnalysisDomainSpec, ...] = (
    ...
    _narrative("provider", "provider", ("annual_reports", "provider_pay_pages", "nhs_jobs"),
    ...
    AnalysisDomainSpec(
        ...
        cross_source_rules=("contract_event",), reporting_views=("structured", "links"),
        quality_contract={"min_comparable_observations": 5}),
    AnalysisDomainSpec(
        domain_id="provider_finance", source_tables=("charity_accounts", "companies"),
        ...
        consolidation_key=("subject_id", "period_end", "metric"), cross_source_rules=("financial_context",),
        reporting_views=("structured", "links"), quality_contract={"min_comparable_observations": 5}),
    AnalysisDomainSpec(
        domain_id="workforce_pay", source_tables=("workforce_census", "nhs_jobs", "provider_pay_pages"),
        ...
        extractor_or_detector="structured_comparison", verification_policy={"canonical_numbers": True},
        consolidation_key=("subject_id", "period_end", "metric"), cross_source_rules=("workforce_context",),
        reporting_views=("structured", "links"), quality_contract={"min_comparable_observations": 5}),
    AnalysisDomainSpec(
        domain_id="treatment_public_health", source_tables=("ndtms_annual", "ndtms_monthly", "fingertips", "la_budgets"),
        ...
        extractor_or_detector="structured_comparison", verification_policy={"canonical_numbers": True},
        consolidation_key=("subject_id", "period_end", "metric"), cross_source_rules=("access_context",),
        reporting_views=("structured", "links"), quality_contract={"min_comparable_observations": 5}),
    AnalysisDomainSpec(
        domain_id="regulation_enforcement", source_tables=("cqc_location_reports", "hse_enforcement_notices"),
        analysis_unit="subject_period_metric", canonical_subject_keys=("provider_id", "authority_id"),
        population_query="SELECT * FROM cqc_location_reports", taxonomy_namespace="regulation",
        extractor_or_detector="structured_comparison", verification_policy={"canonical_numbers": True},
        consolidation_key=("subject_id", "period_end", "metric"), cross_source_rules=("safety_event",),
        reporting_views=("structured", "links"), quality_contract={"min_comparable_observations": 5}),
)
