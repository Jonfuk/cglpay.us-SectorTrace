...
warehouse was not modified. Phase 3 remains open only for the packed Mojo
context kernel and its exact parity evidence; ontology parity is now verified
by the Linux build gate.
