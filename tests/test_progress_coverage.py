...
@pytest.mark.parametrize("name", [
    ...
    "m17_statutory_pay_rates", "m18_living_wage", "m19_data_gov_uk", "m20_gender_pay_gap", "m21_ons_ashe", "m22_provider_pay_pages", "m23_sector_universe", "m24_council_spend", "m25_skills_for_care",
])
