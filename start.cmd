...
REM
REM   PostgreSQL. Set DATABASE_URL in .env. PostgreSQL 18 is the only
REM   application database and every command above reads and writes it.
REM
...
uv sync --quiet %OCR_EXTRA% %STORAGE_EXTRA%
if errorlevel 1 (
