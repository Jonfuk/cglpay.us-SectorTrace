    ...
    <template v-else-if="data">
      ...
      <UCard>
        ...
        <div class="grid gap-4 md:grid-cols-4">
          ...
          <div class="md:col-span-2 flex items-end gap-2"><UButton color="primary" :disabled="busy || !selectedDomains.length" @click="() => { void startRun() }">{{ busy ? 'Working…' : 'Queue analysis run' }}</UButton><UButton color="neutral" variant="outline" @click="() => { void refresh() }">Refresh</UButton></div>
        </div>
