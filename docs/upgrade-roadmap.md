...
### Phases 8–19 — the plan for what is left · 8–11 done, 12–19 planned
...
sequenced. Phases 8–11 are delivered (F-03, the shared furniture, the
artefacts, and the authority spine); nothing from 12 on has been begun; this
section is the order to begin them in and the reasons for it, so that the
